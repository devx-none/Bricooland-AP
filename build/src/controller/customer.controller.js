...
exports.getCustomerHandler = exports.createCustomerHandler = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, customer_service_1.createCustomer)(req.body)];
                case 1:
                    Customer = _a.sent();
                    return [4 /*yield*/, (0, user_service_1.createUser)({
                            email: Customer.email,
                            password: Customer.password,
                            role: constant_1.Roles.CUSTOMER,
                        })];
                case 2:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, customer_service_1.findCustomer)({ user: userId })];
                case 1:
                    Customer = _a.sent();
                    return [2 /*return*/, res.send(Customer)];
            }
