...
var customerSchema = new mongoose_1.default.Schema({
    CustomerId: {
        ...
        required: true,
        unique: true,
        default: function () { return "customer_" + nanoid(); },
    },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    salt = _a.sent();
                    return [4 /*yield*/, bcrypt_1.default.hashSync(customer.password, salt)];
                case 2:
                    hash = _a.sent();
...
customerSchema.methods.comparePassword = function (candidatePassword) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            customer = this;
            return [2 /*return*/, bcrypt_1.default.compare(candidatePassword, customer.password).catch(function (e) { return false; })];
        });
    });
};
