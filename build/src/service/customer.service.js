...
exports.deleteCustomer = exports.findAndUpdateCustomer = exports.findCustomer = exports.createCustomer = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, customer_model_1.default.create(input)];
                case 2:
                    result = _a.sent();
...
function findCustomer(query, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, customer_model_1.default.findOne(query, {}, options)];
                case 2:
                    result = _a.sent();
                    timer(__assign(__assign({}, metricsLabels), { success: "true" }));
                    return [2 /*return*/, result];
...
function findAndUpdateCustomer(query, update, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, customer_model_1.default.findOneAndUpdate(query, update, options)];
        });
    });
}
...
function deleteCustomer(query) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, customer_model_1.default.deleteOne(query)];
        });
    });
}
